...
Usage:
    ...
    uv run scripts/motion/replay_bones_seed_csv.py --input path/to/flip_csv_dir
    uv run scripts/motion/replay_bones_seed_csv.py --input path/to/flip_090_001__A304.csv
